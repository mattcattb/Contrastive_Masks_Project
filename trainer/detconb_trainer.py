...
from utils import logs, eval_util
...
class DetconBTrainer():
    def __init__(self, config):
        ...
        self.logging = logs.get_std_logging()
        if self.rank == 0:
    ...
    def construct_model(self):
        ...
        params = collect_params([self.model.online_network, self.model.predictor],
    ...
    def train_epoch(self, epoch, printer=print):
        ...
        while images is not None:
            ...
            grid = torchvision.utils.make_grid(view1)
            self.writer.add_image("view1", grid, 0)

            # plt.imshow(view1.cpu())
